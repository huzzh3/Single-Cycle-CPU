...
HD_PWD='D:/vivadoProject/SingleCycleCpu/SingleCycleCpu.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Basys3CPU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Basys3CPU.tcl -notrace
