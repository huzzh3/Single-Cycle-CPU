...
HD_PWD='D:/vivadoProject/SingleCycleCpu/SingleCycleCpu.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Basys3CPU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Basys3CPU.tcl
